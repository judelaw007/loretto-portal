// ============================================
// LORETTO SCHOOL PORTAL - SVG ICONS
// ============================================
...
export const Icons = {
  ...
  CreditCard: ({ className, size = 24 }: IconProps) => (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  Megaphone: ({ className, size = 24 }: IconProps) => (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  School: ({ className, size = 24 }: IconProps) => (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function getIcon(name: string): React.ComponentType<IconProps> {
  ...
  return iconMap[name] || Icons.Grid;
}
